...
const Dashboard = ({setAuth}) => {
  ...
  const uploadFile = async(e) => {
    try {
      ...
      const res = await axios.post("http://api.edenlightservice.com/api/upload",formData);
      return res.data;
    }
    catch(ex) {
      console.log(ex);
  ...
  const handleSubmit = async e => {
    ...
    console.log(imgURL);
    axios.post("http://api.edenlightservice.com/api/post",{title:title, paragraph:text, image:imgURL, video:video});
